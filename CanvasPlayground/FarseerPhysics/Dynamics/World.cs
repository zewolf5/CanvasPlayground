...
namespace FarseerPhysics.Dynamics
{
    ...
    public class World
    {
        ...
        private void ProcessRemovedJoints()
        {
            ...
            {
                List<Joint> list;
                lock (_jointRemoveList) list = _jointRemoveList.ToList();
        ...
        private void ProcessAddedJoints()
        {
            ...
            {
                List<Joint> list;
                lock (_jointAddList) list = _jointAddList.ToList();
        ...
        private void ProcessAddedBodies()
        {
            ...
            {
                List<Body> list;
                lock (_bodyAddList) list = _bodyAddList.ToList();
        ...
        private void ProcessRemovedBodies()
        {
            if (_bodyRemoveList.Count > 0)
            {
                ...
                List<Body> list;
                lock (_bodyRemoveList) list = _bodyRemoveList.ToList();
